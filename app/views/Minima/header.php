...
<html lang="en-US">
  ...
  <body class="size-1140">
  	...
  	<a target="_blank" class="hide-s" href="../template/minimalista-premium-responsive-business-template/" style="position:fixed;top:120px;right:-14px;z-index:10;"><im<?=ASSETS?>minima/g src="img/premium-features.png" alt=""></a>
    <div id="page-wrapper">
      <!-- HEADER -->
